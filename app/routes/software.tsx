        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 leading-7">
              <p>
                I'm a freelance full stack web app developer. I've worked on
                other types software and different aspects of the development
                lifecycle (mobile apps, APIs, CI/CD pipelines) over the last ten
                years of professional software development. But I primarily
                develop web applications for small organizations, startups, and
                individuals using modern tech.
              </p>
              <p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-center items-center py-4">
              ...
              >
                <Mail className="h-5 w-5 group-hover:text-theme-purple-light" />
                Get in Touch
              </button>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-4 pl-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      ...
                      <li>
                        Maintained and enhanced Python backend for NLP-based
                        news aggregation, independently delivering bug fixes and
                        improvements
                      </li>
                      <li>
                        Created custom RShiny theme incorporating company
                        branding
                      </li>
                      <li>
                        Mastered Pandas fundamentals and delivered management
                        data visualizations within two weeks
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      <li>
                        Led test-driven development of Python Lambda functions
                        for customized manuscript export using python-docx
                      </li>
                      <li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Self-taught AWS DevOps skills to support infrastructure
                    needs
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="mb-4">
                  ...
                  that exposes participants to different areas of the company,
                  all aspects of the software development lifecycle, and
                  provides technical training. This program was influential in
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  />
                  <p className="text-sm">
                    https://www.backcountrychecklist.com
                  </p>
                </a>
              </div>
            </div>
