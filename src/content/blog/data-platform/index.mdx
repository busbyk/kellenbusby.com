...
title: Data Platform
description: >-
  Audience data access and reporting tool built using the MERN stack & AWS Glue
  for marketers buying audience data.
pubDate: 2025-01-11
tags:
  - client-project
heroImage: ./images/data-platform-cover.avif
heroImageAlt: 'cover photo for the data platform project with tech stack: mongo, express, react, node.js'
---
