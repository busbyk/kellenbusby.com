...
Sadly, I hurt my neck. Finally had a pow day up at Mt. Baker - maybe the best pow day I'll ever have up there because it stayed so consistently cold during that storm. But I ended it by taking a header into a berm and getting a <a href="https://orthoinfo.aaos.org/en/diseases--conditions/burners-and-stingers/" target="_blank" rel="noopener noreferrer">"stinger"</a>. 🤦‍♂️
...
<div className="flex flex-col sm:flex-row my-6 gap-6">
  <BlogVideo
    ...
    caption="Ahhh the joy of sunny pow"
    class="w-full sm:max-w-1/2"
  />
  <BlogVideo
    ...
    caption="Little squirrely in the middle there! haha too fun"
    class="w-full sm:max-w-1/2"
  />
  <BlogVideo
...
import shaky from './images/shaky-tree.gif'
...
/>
<BlogImage src={shaky} alt="gif shaking tree" caption="joy" />
...
import cannon1 from './images/cannon-1.webp'
import cannon2 from './images/cannon-2.webp'

<ImageRow
  images={[cannon1, cannon2]}
  alts={['cannon', 'cannon festivus']}
  captions={['"not bad"', "Always gotta visit the 4080'"]}
/>
...
import raggedSki from './images/ragged-ski.webp'
import raggedSelfie from './images/ragged.webp'

<ImageRow images={[raggedSki, raggedSelfie]} alts={['ragged', 'ragged']} />
...
import bolton from './images/bolton.webp'

<BlogImage
  src={bolton}
  alt="bolton valley"
  caption="Lake Champlain is over there. And New York..."
/>
...
<BlogImage
  src={christmas}
  alt="christmas with the fam"
  caption="Christmas morning before everyone else arrived"
/>
...
import wineSelfie from './images/wine-selfie.webp'
import bibimbap from './images/bibimbap.webp'

<BlogImage
  src={bibimbap}
  alt="bibimbap"
  caption="We kindly request a re-do of this one time that Jon made Bibimbap - he delivered again - how pretty!"
/>
<ImageRow images={[wineSelfie, mug]} alts={['j&k', 'k&j']} />
...
import spreadEagle from './images/spread-eagle.gif'

<BlogImage src={spreadEagle} alt="spread eagle gif" caption="no fun was had" />
